            ...
            collection.variableIds.forEach((otherVariableId) => {
                ...
                if (otherVariable && modeValue && typeof modeValue === "object") {
                    ...
                    if (variable.name !== otherVariable.name && // Avoid self-reference
                        ...
                        tmpVariable = (0,_handleVariableAlias__WEBPACK_IMPORTED_MODULE_4__["default"])(variable, modeValue, mode);
                        // @ts-ignore
                        tmpVariable = (0,_deepMerge__WEBPACK_IMPORTED_MODULE_6__["default"])(tmpVariable, { aliasSameMode: true });
                    }
                }
            });
        }
...
const processAliasModes = (variables) => {
    return variables.reduce((collector, variable) => {
        ...
        collector.push(Object.assign(Object.assign({}, variable), { values: variable.values.replace(`{${aliasCollectionName}.`, `{${aliasCollectionName}.${aliasMode.name}.`) }));
        return collector;
    }, []);
};
