...
const getVariables = (figma, settings) => {
    ...
    const variables = figma.variables
        .getLocalVariables()
        .filter((variable) => (settings.exportHideFromPublish || !variable.hiddenFromPublishing) &&
